...
public class Tpiece extends Block{
    ...
    public Tpiece(int y, int x){
        super(y,x,new Color(235,80,230));
        ...
        rotations[1][3] = new Point(1, 1);

        rotations[0][0] = new Point(0, 2);
        rotations[0][1] = new Point(1, 1);
        rotations[0][2] = new Point(1, 2);
        rotations[0][3] = new Point(2, 2);
    }
